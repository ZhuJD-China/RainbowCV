...
def main():
    fruits = cv2.imread('D:\\RainbowCV\\RainbowCV\\TestApp\\images\\bear.jpg', cv2.IMREAD_COLOR)
    ...
    settings = EnhancedWindow(0, 0, fruits.shape[0]/3, fruits.shape[1]/3, 'Settings')
