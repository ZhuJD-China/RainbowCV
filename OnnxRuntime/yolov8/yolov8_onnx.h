...
{
public:
	Yolov8Onnx() : _OrtMemoryInfo(Ort::MemoryInfo::CreateCpu(OrtDeviceAllocator, OrtMemTypeCPUOutput))
	{
	};
...
private:
	...
	const int _netHeight = 1280;  //ONNX-net-input-height
	...
	//ONNXRUNTIME	
	Ort::Env _OrtEnv = Ort::Env(ORT_LOGGING_LEVEL_ERROR, "Yolov8");
