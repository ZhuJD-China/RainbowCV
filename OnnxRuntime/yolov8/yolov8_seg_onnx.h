...
{
public:
	Yolov8SegOnnx() : _OrtMemoryInfo(Ort::MemoryInfo::CreateCpu(OrtDeviceAllocator, OrtMemTypeCPUOutput))
	{
	};
...
private:
	...
	const int _netWidth = 1280;   //ONNX-net-input-width
	const int _netHeight = 1280;  //ONNX-net-input-width
	...
	//ONNXRUNTIME	
	Ort::Env _OrtEnv = Ort::Env(ORT_LOGGING_LEVEL_ERROR, "Yolov8-Seg");
